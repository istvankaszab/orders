...
include('copier-karorauzlet1.php');
include('copier-szotargepcentrum.php');
include('copier-karoracentrum1.php');
include('copier-legjobbajanlat1.php');
include('copier-karoracentrum-new.php');
